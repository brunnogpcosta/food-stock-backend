...
export class EntradaResolver {
  ...
  @Mutation(() => Entrada)
  createEntrada(@Args('createEntradaInput') createEntradaInput: CreateEntradaInput) {
  ...
  @Mutation(() => Entrada)
  updateEntrada(@Args('updateEntradaInput') updateEntradaInput: UpdateEntradaInput) {
    return this.entradaService.update(updateEntradaInput.id, updateEntradaInput);
  }
