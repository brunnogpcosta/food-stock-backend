...
export class UnidadeMedidaResolver {
  ...
  createUnidadeMedida(@Args('createUnidadeMedidaInput') createUnidadeMedidaInput: CreateUnidadeMedidaInput) {
  ...
  @Mutation(() => UnidadeMedida)
  updateUnidadeMedida(@Args('updateUnidadeMedidaInput') updateUnidadeMedidaInput: UpdateUnidadeMedidaInput) {
    return this.unidadeMedidaService.update(updateUnidadeMedidaInput.id, updateUnidadeMedidaInput);
  }
